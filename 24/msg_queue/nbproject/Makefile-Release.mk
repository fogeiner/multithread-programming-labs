...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/msg_queue

dist/Release/GNU-Linux-x86/msg_queue: ${OBJECTFILES}
...
${OBJECTDIR}/_ext/_DOTDOT/Semaphore.o: nbproject/Makefile-${CND_CONF}.mk ../Semaphore.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/Semaphore.o ../Semaphore.cpp

${OBJECTDIR}/_ext/_DOTDOT/Thread.o: nbproject/Makefile-${CND_CONF}.mk ../Thread.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/Thread.o ../Thread.cpp

${OBJECTDIR}/_ext/_DOTDOT/MsgQueue.o: nbproject/Makefile-${CND_CONF}.mk ../MsgQueue.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/MsgQueue.o ../MsgQueue.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/msg_queue
